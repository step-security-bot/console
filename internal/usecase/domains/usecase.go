...
var (
	...
	ErrDatabase       = sqldb.DatabaseError{Console: consoleerrors.CreateConsoleError("DomainsUseCase")}
	ErrNotFound       = sqldb.NotFoundError{Console: consoleerrors.CreateConsoleError("DomainsUseCase")}
)
